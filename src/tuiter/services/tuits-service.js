...
// const TUITS_API = 'https://tuiter-node-server-app-triet-263d9c91d958.herokuapp.com/api/tuits';

const API_BASE = process.env.REACT_APP_API_BASE;const TUITS_API = `${API_BASE}/tuits`;
